...
const Flex = forwardRef<HTMLDivElement, FlexProps>(
	({ children, className, column = false, align = 'normal', justify = 'normal', center, style, ...rest }, ref) => {
		...
		const { maxWidth, fullWidth, fullHeight, backgroundColor, borderRadius, ...domSafeProps } = rest;
